...
#
#         self.Linear = torch.nn.Linear(768, class_num, bias=True)
#
#         x_size = 200
#
#         h_size = 200
...
#         return edges, old_edge_id
#
#     def seq_to_graph(self, doc_ids: list) -> dgl.DGLGraph().to('cuda:0'):
#         if len(doc_ids) > self.max_length:
#             doc_ids = doc_ids[:self.max_length]
#
#         local_vocab = set(doc_ids)
...
#         # local_node_hidden.to('cuda:0')
#
#         sub_graph.ndata['h'] = local_node_hidden.to('cuda:0')
#
...
#         c = th.zeros((n, h_size))
#
#         embeds = self.node_hidden(batch_graph.nodes())
#         batch_graph.ndata['iou'] = self.cell.W_iou(self.dropout(embeds)).to('cuda:0')
#         batch_graph.ndata['h'] = h.to('cuda:0')
#         batch_graph.ndata['c'] = c.to('cuda:0')
#
#         # LSTM层
#         # dgl.prop_nodes_topo(batch_graph,
