...
def cal_PMI(dataset: str, window_size=20):
    ...
    content, label, _ = helper.get_content()
...
if __name__ == "__main__":
    edges_weights, edges_mappings, count = cal_PMI('imdb')
    print('edges_weights',edges_weights.shape, edges_weights)
    print('edges_mappings', len(edges_mappings), edges_mappings)
    print('count', count)